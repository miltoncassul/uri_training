...
dist_total = int(input())   #entrada da distãncia total
comb_gasto = float(input()) #entrada do combustível gasto

cons_medio_autom = dist_total / comb_gasto  # Cálculo do consumo médio do altomovél

print("{:.3f} km/l".format(cons_medio_autom))
